...
CLOSED_STYLE = {
    ...
    "backgroundColor": {"red": 1, "green": 0.0, "blue": 0.0},
}
...
def create_new_worksheet():
    ...
    new_worksheet.format("A1:B1", {"textFormat": {"bold": True}})
...
def get_revenue(data):
    ...
    time.sleep(2)
    # prices variable takes data from row 4 starting from index 1 to 6
    prices = CLINIC_SHEET.worksheet("dr-heart-revenue").row_values(4)[1:7]
    # tests variable only takes the tally result, from index 1 to 6
    tests = data[1:7]
    test_rev = []
